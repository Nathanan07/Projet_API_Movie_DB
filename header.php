...
<html lang="fr">
  ...
  <nav class="navbar fixed navbar-expand-md navbar-dark text-white bg-dark shadow py-2">
    <div class="container">
      ...
      <div class="navbar-collapse collapse" id="collapsingNavbar3">
        ...
        <ul class="nav navbar-nav w-100 justify-content-end">
          ...
          <!-- BUG CORRIGÉ : action pointait vers "#", maintenant vers searchMovies.php -->
          <div class="form-outline me-3">
            <form action="searchMovies.php" id="search-movies" method="get">
          ...
          <!-- BUG CORRIGÉ : action pointait vers "#", maintenant vers searchActeurs.php -->
          <div class="form-outline me-3">
            <form action="searchActeurs.php" id="search-acteurs" method="get">
